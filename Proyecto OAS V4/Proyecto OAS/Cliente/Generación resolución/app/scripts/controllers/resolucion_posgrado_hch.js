...
/**
 * @ngdoc function
 * @name generacionResolucionApp.controller:ResolucionPosgradoHchCtrl
 * @description
 * # ResolucionPosgradoHchCtrl
 * Controller of the generacionResolucionApp
 */
angular.module('generacionResolucionApp')
  .controller('ResolucionPosgradoHchCtrl', function (resolucion_request) {
