...
/**
 * @ngdoc function
 * @name generacionResolucionApp.controller:ResolucionPregradoHcpCtrl
 * @description
 * # ResolucionPregradoHcpCtrl
 * Controller of the generacionResolucionApp
 */
angular.module('generacionResolucionApp')
  .controller('ResolucionPregradoHcpCtrl', function (resolucion_request) {
